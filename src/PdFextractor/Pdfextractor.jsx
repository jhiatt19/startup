...
import { BuiltScript, ScriptBuilder } from "./ScriptBuilder.js";
...
export function PDFextractor() {
  ...
  return (
    <main>
      <h2>PDF extractor</h2>{" "}
      {/*I have created a script for this already so this will have a 3rd party call to get to the Tesseract OCR open source code, but the actual script will be locally hosted*/}
      <section>
        <form
          id="extractorStuff"
          action="PDFextractor.html"
          onSubmit={handleSubmit}
        >
          <div>
            <label className="extractor" htmlFor="pdfFile">
          ...
          <div>
            <label className="fileTypeSelector" htmlFor="fileType">
              What kind of file would you like text added to?
            </label>
            <select
              ref={optionInputRef}
            ...
            <p>
              The pdf option returns a searchable pdf and the html returns a
              hOCR file.
            </p>
          </div>
          <input
